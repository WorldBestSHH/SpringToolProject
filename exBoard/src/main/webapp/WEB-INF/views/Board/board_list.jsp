				...
				<table border="0" cellspacing="1" width="100%" align="center">
					...
					<tr>
						<td colspan="5" align="right" valign="middle" height="20">
							<font size="2" face="고딕">전체 : <b>${count}</b>건 - 1/ 2 Pages</font>
						</td>
					</tr>
					<tr bgcolor="e3e9ff">
					...
					<c:forEach var="board" items="${list}">
						<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
							<td align="center" height="25"><font face="돋움" size="2" color="#000000">${board.idx}</font></td>
							<td align="left" height="20">&nbsp; <font face="돋움" size="2" color="#000000"> 
								<a class="list" href="/Board/board_hits?idx=${board.idx}">${board.subject}</a>
							</td>
					...
					<div align="center">
						...
						<table width="600">
							<tr>
								...
								<td width="25%" align="right"><a href="/Board/board_write"><img src="/img/write.gif" border="0"></a></td>
							</tr>
						</table>
</body>
</html>
