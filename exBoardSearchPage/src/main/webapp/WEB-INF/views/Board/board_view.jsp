	...
	<table border="0" width="800">
		<tr>
			...
			<td width="80%" valign="top">&nbsp;<br>
				...
				<p align="center">
					<font size="2">
						<!-- 새글쓰기 --><a href="/Board/board_write?page=${page}"><img src="/img/write.jpg" border="0"></a>&nbsp;&nbsp; 
						<!-- 수정하기 --><a href="/Board/board_modify?idx=${board.idx}&page=${page}"><img src="/img/edit.gif" border="0"></a>&nbsp;&nbsp;
						<!-- 삭제하기 --><a href="javascript:board_delete()"><img src="/img/del.gif" border="0"></a>&nbsp;&nbsp;
						<!-- 목록보기 --><a href="/Board/board_list?page=${page}"><img src="/img/list-2.gif" border="0"></a>&nbsp;&nbsp;
					</font></td>
		</tr>
	</table>
</body>
